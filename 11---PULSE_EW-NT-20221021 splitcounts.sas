...
proc sort data=week_all out=week_all;
	by week female agegroup1 hisprace educ allewgrp_layer3 descending shot;
...
proc surveyfreq data=week_all varmethod=BRR(FAY);
	...
	by week female agegroup1 hisprace educ allewgrp_layer3;
run;

Proc export data=PULSE_pop 
	outfile='C:\Users\npr8\OneDrive - USNH\2022---Household-PULSE-Data-Analysis\SAS\PULSE_pop.csv' 
	dbms=csv 
	replace;
run;
