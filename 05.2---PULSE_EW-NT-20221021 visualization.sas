...
proc sort data=week_all out=week_all;
	by week est_st female agegroup1 hisprace educ allewgrp_layer3 descending shot;
run;
...
proc surveyfreq data=week_all varmethod=BRR(FAY);
	...
	table shot;
	ods output oneway=PUSLE_pop_shot;
	by week est_st female agegroup1 hisprace educ allewgrp_layer3;
run;
